...
import { mount } from "about/Module";
import { app2RoutingPrefix } from "../constants";
...
export default () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener("[about] navigated", app2NavigationEventHandler);
  ...
  return <div ref={wrapperRef} id="about-mfe" />;
};
